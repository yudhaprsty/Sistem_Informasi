<?php
	...
	if($_SESSION['status'] == "nouser"){
		...
		$query_produk = mysqli_query($con, "SELECT * FROM daftar_harga WHERE id_produk = '$id_produk'");
		$result_produk = mysqli_fetch_array($query_produk, MYSQLI_ASSOC);
?>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                  <form class="form-horizontal form-label-left" action="hub_update_produk.php" method="post">
											<div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12">Jenis Perawatan
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
												  <input class="form-control col-md-7 col-xs-12" type="text" value="<?php echo $result_produk['jenis_perawatan'];?>" name="jenis_perawatan">
												</div>
											</div>
											<div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Perawatan
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
												  <input class="form-control col-md-7 col-xs-12" type="text" value="<?php echo $result_produk['nama_perawatan'];?>" name="nama_perawatan">
												</div>
											</div>
											<div class="item form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12"><span class="required">Harga
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
												  <input class="form-control col-md-7 col-xs-12" type="text" value="<?php echo $result_produk['harga_perawatan'];?>" name="harga_perawatan">
												</div>
											</div>
