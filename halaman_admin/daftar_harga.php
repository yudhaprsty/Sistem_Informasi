				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>Daftar Harga</h2>
								<a href="input_produk.php" style="float: right" class="btn btn-success">Tambah Perawatan</a>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
											...
											if($result->num_rows > 0) {
												while($row = $result->fetch_assoc()) {
													echo "<tr>
															...
															<td>Rp ".$row['harga_perawatan']."</td>
															<td>
																<a href='halaman_edit_daftar_harga.php?id_produk=".$row['id_produk']."'><button type='button' class='btn btn-info'>Edit</button></a>
																<a href='delete_produk.php?id_produk=".$row['id_produk']."'><button type='button' class='btn btn-danger'>Delete</button></a>
															</td>
														</tr>";
													}
												}
