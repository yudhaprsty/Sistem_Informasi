    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Usia', 'Jumlah Pasien'],
          ['Usia <20', <?php echo $jumlah_usia1; ?>],
          ['Usia >20', <?php echo $jumlah_usia2; ?>],
        ]);
				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_content">
									<form class="form-horizontal form-label-left" action="hub_input_data_treatment.php" method="post">
										...
										<div class="form-group">
											<div class="col-md-6 col-md-offset-3">
											  <a href="daftar_pasien.php" class="btn btn-primary">Cancel</a>
