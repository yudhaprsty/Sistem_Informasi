              	...
              	<center class="m-t-30">
									<?php
										if($result['foto_profil'] == ""){
											echo "<img src='images/picture.jpg' width='120px' class='img-circle' width='150'>";
										} else{
											echo "<img src=".$result['foto_profil']." width='120px' class='img-circle' width='150'>";
										}
									?>
                  <form action="hub_update_foto_pegawai.php" name="uploader" method="post" enctype="multipart/form-data">
          ...
          <div class="col-lg-8 col-xlg-9 col-md-7">
          	<div class="card">
            	<div class="card-block">
								...
								?>
                <form class="form-horizontal form-material" action="hub_edit_pegawai.php" method="post">
