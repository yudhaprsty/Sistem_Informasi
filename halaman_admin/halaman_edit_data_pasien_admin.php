				...
				<div class="">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
								<div class="x_content">
									<form class="form-horizontal form-label-left" action="hub_update_data_pasien_admin.php" method="post">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 col-xs-12">
											  <select name="pekerjaan_pasien" class="form_control btn btn-default dropdown-toggle">
										...
										<div class="form-group">
											<div class="col-md-6 col-md-offset-3">
											  <button href="daftar_pasien.php" class="btn btn-primary">Cancel</button>
