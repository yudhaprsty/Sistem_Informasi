<?php
	...
	$sql = "SELECT * FROM data_pasien WHERE nama_pasien like '%$nama_pasien%'";
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				<div class="page-title">
					...
					<form action="halaman_depan_pegawai_pencarian.php" method="post">
										...
										<?php
											...
											while($row = $hasil->fetch_assoc()) {
													echo "<tr>
															...
															<td>".$row['alergi']."</td>
															<td>
																<a href='pendaftaran_treatment_pegawai.php?id_pasien=".$row['id_pasien']."'><button type='button' class='btn btn-dark'>Tambah Treatment</button></a>
																</br>
																<a href='halaman_edit_data_pasien_pegawai.php?id_pasien=".$row['id_pasien']."'><button type='button' class='btn btn-info'>Edit</button></a>
